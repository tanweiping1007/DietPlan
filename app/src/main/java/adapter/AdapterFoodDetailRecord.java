...
public class AdapterFoodDetailRecord extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterFoodDetailRecord(Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        {
            View viewer = layoutInflater.inflate(R.layout.activity_food_detail_header,parent,false);
            HeaderViewHolder holder = new HeaderViewHolder(viewer);
            return holder;
        }
        else
        {
            View viewer = layoutInflater.inflate(R.layout.activity_food_detail_item,parent,false);
